...
[
    ...
    "Debug: Better Convoy Zeus", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    ["Motti_Misc", "Debug"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
