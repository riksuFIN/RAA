...
[
    ...
    "Debug: SaveLoad", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
...
[
    QGVAR(showSettings), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    ["Write Settings to Map's Briefing", "If enabled settings defined in modules can be viewed in-game via Briefing tab on map."], // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
    ["RAA", "SaveLoad"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
