...
[
    "RAA_animation_enableAnimMenu", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    "Enable Self Animations Menu", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
...
[
    "RAA_animation_enableDebugOptions", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    "Debug: Animations", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
